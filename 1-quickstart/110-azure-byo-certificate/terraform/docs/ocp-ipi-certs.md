# OpenShift IPI Certificates

## Module overview

### Description

Module that replaces OpenShift default ingress and API server certificates.
...
- Azure ACME certificate - github.com/cloud-native-toolkit/terraform-azure-acme-certificate
- Azure OpenShift IPI - github.com/cloud-native-toolkit/terraform-azure-ocp-ipi

### Example usage

```hcl-terraform
module "api-certs" {
  source = "https://github.com/cloud-native-toolkit/terraform-any-ocp-ipi-certs"
